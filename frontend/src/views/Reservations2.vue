...
async function fetchReservations() {
  ...
  try {
    ...
    allHotels.value = [
    { id: 'hotel_1', name: 'Hotel de Paris', image: "/rooms/example.jpg", rating: 4, alert: false, originalPrice: 230, agreedPrice: 220, status: 'Acceptées', distance: '3,4km', address: 'Paris, 32 Rue de Rivoli' },
